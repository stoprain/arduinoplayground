...
//【此数值可能需要调节】
#define SERVOLEFTNULL 2050  //数值减小，顺时针旋转，加大则逆时针旋转
//【此数值可能需要调节】
#define SERVORIGHTNULL 975  //数值减小，顺时针旋转，加大则逆时针旋转
...
//升举抬臂舵机的3个角度 
//【此数值可能需要调节】
#define LIFT0 1900  //落笔写字 on drawing surface
#define LIFT1 1800  //写字时抬臂动作 between numbers
#define LIFT2 1400  //高抬笔架  going towards sweeper 
//【此数值可能需要调节】
...
void press(float x, float y, float z) {
    drawTo(x, y);
	  delay(300);
